...
"use strict";var e=s(require("@babel/runtime-corejs2/regenerator")),t=s(require("@babel/runtime-corejs2/helpers/asyncToGenerator"));require("./scss/app.scss");var r=s(require("./services/quotes")),n=s(require("./services/google")),u=o(require("./utils")),a=s(require("./data"));function i(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return i=function(){return e},e}function o(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=i();if(t&&t.has(e))return t.get(e);var r={},n=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var u in e)if(Object.prototype.hasOwnProperty.call(e,u)){var a=n?Object.getOwnPropertyDescriptor(e,u):null;a&&(a.get||a.set)?Object.defineProperty(r,u,a):r[u]=e[u]}return r.default=e,t&&t.set(e,r),r}function s(e){return e&&e.__esModule?e:{default:e}}var c="PLuCUpg5b_vRqWMNwIH5oazz_qD170NtI4",l=null,f=u.get_by_id("main"),d=u.query(".loader"),p=u.get_by_id("quote"),y=u.query(".buttons-wrapper.left"),g=u.query(".buttons-wrapper.right"),m=u.query(".buttons-wrapper.play"),_=u.query(".button-play"),v=u.get_by_id("button-vol-input"),b=u.get_by_id("current-song"),h=u.get_by_id("timer"),w=function(){return 1===l.getPlayerState()},q=function(e){var t=e.target.value;l&&(console.log("akaoe"),l.setVolume(t))};v.oninput=q;var x=function(){if(w())return d.classList.remove("loading"),void d.classList.add("static");d.classList.remove("static"),d.classList.add("loading")},P=function(){var e=u.create_el("img"),t=u.random_number(0,a.default.length-1);!function r(){var n=u.random_number(0,a.default.length-1);t=n;var i=a.default[t];e.src=i,setTimeout(r,5e3)}(),f.appendChild(e)},k=function(){var e={current_time:null,init:function(e){this.on_update_timer=e,this.update_timer()},update_timer:function(){var e=this,t=new Date,r=u.format_number(t.getHours()),n=u.format_number(t.getSeconds()),a=u.format_number(t.getMinutes());this.current_time=u.format_hour(r,a,n),this.on_update_timer(this),setTimeout(function(){return e.update_timer()},1e3)}};e.init(function(e){var t=e.current_time;return h.textContent=t})},j=function(){var n=(0,t.default)(e.default.mark(function t(){var n,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,r.default.get_quotes();case 2:n=e.sent,i=n[u.random_number(0,a.default.length-1)].text,p.textContent=i;case 5:case"end":return e.stop()}},t)}));return function(){return n.apply(this,arguments)}}(),O=function(){var e=w();_.classList.add(e?"playing":"paused"),_.classList.remove(e?"paused":"playing")},L=function(){1===l.getPlayerState()?l.pauseVideo():l.playVideo()},M=function(){y.onclick=function(){return l.previousVideo()},g.onclick=function(){return l.nextVideo()},m.onclick=function(){return L()}},V=function(){k(),j(),M()},C=function(){var r=(0,t.default)(e.default.mark(function t(){var r,a,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,n.default.get_playlist_count(c);case 2:r=e.sent,a=function(e){e.target.loadPlaylist({list:c,listType:"playlist",index:u.random_number(0,r-1),startSeconds:0,suggestedQuality:"small"})},i=function(e){b.setAttribute("href",e.target.playerInfo.videoUrl),x(),O()},l=new YT.Player("player",{height:"300",width:"300",playerVars:{controls:"0",autoplay:"1"},events:{onReady:a,onStateChange:i}});case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}(),S=function(){var r=(0,t.default)(e.default.mark(function t(){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,P();case 2:return e.next=4,V();case 4:return e.next=6,C();case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}();window.onload=S;
...
//# sourceMappingURL=/lofi-player/app.79300e71.js.map