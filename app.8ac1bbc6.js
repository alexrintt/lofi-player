...
"use strict";var e=s(require("@babel/runtime-corejs2/regenerator")),t=s(require("@babel/runtime-corejs2/helpers/asyncToGenerator"));require("./scss/app.scss");var r=s(require("./services/quotes")),n=s(require("./services/google")),u=o(require("./utils")),a=s(require("./data"));function i(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return i=function(){return e},e}function o(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=i();if(t&&t.has(e))return t.get(e);var r={},n=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var u in e)if(Object.prototype.hasOwnProperty.call(e,u)){var a=n?Object.getOwnPropertyDescriptor(e,u):null;a&&(a.get||a.set)?Object.defineProperty(r,u,a):r[u]=e[u]}return r.default=e,t&&t.set(e,r),r}function s(e){return e&&e.__esModule?e:{default:e}}var l,c="PLuCUpg5b_vRqWMNwIH5oazz_qD170NtI4",f=null,d=u.get_by_id("main"),p=u.query(".loader"),m=u.get_by_id("quote"),y=u.query(".buttons-wrapper.left"),_=u.query(".buttons-wrapper.right"),g=u.query(".buttons-wrapper.play"),v=u.query(".button-play"),b=u.get_by_id("button-vol-input"),h=u.get_by_id("current-song"),w=u.get_by_id("timer"),q="app__vol__level",x=Number(localStorage.getItem(q))||100,P=function(){return 1===f.getPlayerState()},k=function(e){var t=e.target.value;f&&(x=t,f.setVolume(x),localStorage.setItem(q,t))};b.value=x,b.oninput=k;var j=function(){if(P())return p.classList.remove("loading"),void p.classList.add("static");p.classList.remove("static"),p.classList.add("loading")},O=function(){var e=u.create_el("img"),t=u.random_number(0,a.default.length-1);!function r(){var n=u.random_number(0,a.default.length-1);t=n;var i=a.default[t];e.src=i,setTimeout(r,5e3)}(),d.appendChild(e)},S=function(){var e={current_time:null,init:function(e){this.on_update_timer=e,this.update_timer()},update_timer:function(){var e=this,t=new Date,r=u.format_number(t.getHours()),n=u.format_number(t.getSeconds()),a=u.format_number(t.getMinutes());this.current_time=u.format_hour(r,a,n),this.on_update_timer(this),setTimeout(function(){return e.update_timer()},1e3)}};e.init(function(e){var t=e.current_time;return w.textContent=t})},L=function(){var n=(0,t.default)(e.default.mark(function t(){var n,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,r.default.get_quotes();case 2:n=e.sent,i=n[u.random_number(0,a.default.length-1)].text,m.textContent=i;case 5:case"end":return e.stop()}},t)}));return function(){return n.apply(this,arguments)}}(),V=function(){var e=P();v.classList.add(e?"playing":"paused"),v.classList.remove(e?"paused":"playing")},M=function(){f&&(1===f.getPlayerState()?f.pauseVideo():f.playVideo())},T=function(){f&&l&&f.loadPlaylist({list:c,listType:"playlist",index:u.random_number(0,l-1),startSeconds:0,suggestedQuality:"small"})},C=function(){y.onclick=function(){return f&&f.previousVideo()},_.onclick=function(){return f&&f.nextVideo()},g.onclick=function(){return M()},g.ondblclick=function(){return f&&T()}},I=function(){S(),L(),C()},D=function(){var r=(0,t.default)(e.default.mark(function t(){var r,a;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,n.default.get_playlist_count(c);case 2:l=e.sent,r=function(e){e.target.loadPlaylist({list:c,listType:"playlist",index:u.random_number(0,l-1),startSeconds:0,suggestedQuality:"small"})},a=function(e){h.setAttribute("href",e.target.playerInfo.videoUrl),j(),V(),f.setVolume(x)},f=new YT.Player("player",{height:"300",width:"300",playerVars:{controls:"0",autoplay:"1"},events:{onReady:r,onStateChange:a}});case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}(),N=function(){var r=(0,t.default)(e.default.mark(function t(){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,O();case 2:return e.next=4,I();case 4:return e.next=6,D();case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}();window.onload=N;
...
//# sourceMappingURL=/lofi-player/app.8ac1bbc6.js.map