...
"use strict";var e=s(require("@babel/runtime-corejs2/regenerator")),t=s(require("@babel/runtime-corejs2/helpers/asyncToGenerator"));require("./scss/app.scss");var r=s(require("./services/quotes")),n=s(require("./services/google")),u=o(require("./utils")),a=s(require("./data"));function i(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return i=function(){return e},e}function o(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=i();if(t&&t.has(e))return t.get(e);var r={},n=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var u in e)if(Object.prototype.hasOwnProperty.call(e,u)){var a=n?Object.getOwnPropertyDescriptor(e,u):null;a&&(a.get||a.set)?Object.defineProperty(r,u,a):r[u]=e[u]}return r.default=e,t&&t.set(e,r),r}function s(e){return e&&e.__esModule?e:{default:e}}var l="PLuCUpg5b_vRqWMNwIH5oazz_qD170NtI4",c=null,f=u.get_by_id("main"),d=u.query(".loader"),p=u.get_by_id("quote"),m=u.query(".buttons-wrapper.left"),_=u.query(".buttons-wrapper.right"),y=u.query(".buttons-wrapper.play"),g=u.query(".button-play"),v=u.get_by_id("button-vol-input"),b=u.get_by_id("current-song"),h=u.get_by_id("timer"),w="app__vol__level",q=Number(localStorage.getItem(w))||100,x=function(){return 1===c.getPlayerState()},P=function(e){var t=e.target.value;c&&(q=t,c.setVolume(q),localStorage.setItem(w,t))};v.value=q,v.oninput=P;var j=function(){if(x())return d.classList.remove("loading"),void d.classList.add("static");d.classList.remove("static"),d.classList.add("loading")},k=function(){var e=u.create_el("img"),t=u.random_number(0,a.default.length-1);!function r(){var n=u.random_number(0,a.default.length-1);t=n;var i=a.default[t];e.src=i,setTimeout(r,5e3)}(),f.appendChild(e)},O=function(){var e={current_time:null,init:function(e){this.on_update_timer=e,this.update_timer()},update_timer:function(){var e=this,t=new Date,r=u.format_number(t.getHours()),n=u.format_number(t.getSeconds()),a=u.format_number(t.getMinutes());this.current_time=u.format_hour(r,a,n),this.on_update_timer(this),setTimeout(function(){return e.update_timer()},1e3)}};e.init(function(e){var t=e.current_time;return h.textContent=t})},L=function(){var n=(0,t.default)(e.default.mark(function t(){var n,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,r.default.get_quotes();case 2:n=e.sent,i=n[u.random_number(0,a.default.length-1)].text,p.textContent=i;case 5:case"end":return e.stop()}},t)}));return function(){return n.apply(this,arguments)}}(),S=function(){var e=x();g.classList.add(e?"playing":"paused"),g.classList.remove(e?"paused":"playing")},V=function(){c&&(1===c.getPlayerState()?c.pauseVideo():c.playVideo())},M=function(){m.onclick=function(){return c&&c.previousVideo()},_.onclick=function(){return c&&c.nextVideo()},y.onclick=function(){return V()}},C=function(){O(),L(),M()},I=function(){var r=(0,t.default)(e.default.mark(function t(){var r,a,i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,n.default.get_playlist_count(l);case 2:r=e.sent,a=function(e){e.target.loadPlaylist({list:l,listType:"playlist",index:u.random_number(0,r-1),startSeconds:0,suggestedQuality:"small"})},i=function(e){b.setAttribute("href",e.target.playerInfo.videoUrl),j(),S(),c.setVolume(q)},c=new YT.Player("player",{height:"300",width:"300",playerVars:{controls:"0",autoplay:"1"},events:{onReady:a,onStateChange:i}});case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}(),T=function(){var r=(0,t.default)(e.default.mark(function t(){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,k();case 2:return e.next=4,C();case 4:return e.next=6,I();case 6:case"end":return e.stop()}},t)}));return function(){return r.apply(this,arguments)}}();window.onload=T;
...
//# sourceMappingURL=/lofi-player/app.8d18eaa1.js.map